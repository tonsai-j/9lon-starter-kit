...
// import '@polymer/paper-input/paper-inputห'
                ...
                <div class="container">
                    <h1 class="title">
                        ...
                        <div class="columns is-mobile">
                            <!-- <div class="column">
                                <a class="button is-info is-focused">ย้อนกลับ</a>
                            </div> -->
                            <div class="column ">ข้อมูลระบบ</div>
                            <!-- <div class="column">3</div> -->
                            <!-- <div text-align="right">
                                <a class="button is-info is-focused">แก้ไข</a>
                            </div> -->
                        </div>
                    </h1>
                    <h2 class="subtitle">
